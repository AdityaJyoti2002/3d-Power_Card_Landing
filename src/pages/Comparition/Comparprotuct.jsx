...
const ComparProtuct = () => {
  return (
    <section class="text-gray-700 body-font bg-gradient-to-br from-[#f9fafb] via-[#f3f4f6] to-[#e5e7eb] overflow-hidden border-t border-gray-200 z-10 relative">
